...
> **Status (2026-05):** All tasks **T001–T087** are marked **done** on `main` (checklist reconciled with shipped code, tests, `quickstart.md`, and `contracts/api.md`). Re-run verification commands in T084–T086 before releases.
...
- [x] T003 [P] Create frontend run component folder marker in `src/frontend/src/components/runs/.gitkeep`
...
- [x] T086 Run frontend lint, tests, and build with `npm run lint`, `npm run test`, and `npm run build` in `src/frontend`
